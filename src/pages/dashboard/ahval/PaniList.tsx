...
const PaniList = () => {
  ...
  useEffect(() => {
    document.title = 'Pani List - पाणी व्यवस्था यादी';
    (async () => {
  ...
  const handleViewReport = (ward: string | number) => {
    sessionStorage.setItem('paniReportWard', String(ward));
    const newWindow = window.open('/view-pani-report', '_blank');
    if (newWindow) {
