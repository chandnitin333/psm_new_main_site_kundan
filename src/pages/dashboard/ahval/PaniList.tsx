...
const PaniList = () => {
  ...
  const [wardsData] = useState<WardData[]>([
    { wardNo: 1, wardName: 'प्रभाग १', totalProperties: 150, totalPopulation: 780, waterConnected: 720 },
    { wardNo: 2, wardName: 'प्रभाग २', totalProperties: 200, totalPopulation: 1050, waterConnected: 950 },
    { wardNo: 3, wardName: 'प्रभाग ३', totalProperties: 180, totalPopulation: 920, waterConnected: 870 },
    { wardNo: 4, wardName: 'प्रभाग ४', totalProperties: 165, totalPopulation: 850, waterConnected: 790 },
    { wardNo: 5, wardName: 'प्रभाग ५', totalProperties: 190, totalPopulation: 980, waterConnected: 910 },
    { wardNo: 6, wardName: 'प्रभाग ६', totalProperties: 175, totalPopulation: 890, waterConnected: 840 },
    { wardNo: 7, wardName: 'प्रभाग ७', totalProperties: 195, totalPopulation: 1020, waterConnected: 960 },
    { wardNo: 8, wardName: 'प्रभाग ८', totalProperties: 185, totalPopulation: 950, waterConnected: 880 },
  ]);

  // Auto-load page with loader
  useEffect(() => {
    document.title = 'Water List - पाणी यादी';
  ...
  const handleViewReport = async (ward: WardData) => {
    ...
    sessionStorage.setItem('paniReportWard', JSON.stringify(ward));

    // Open report in new tab
    const url = `/view-pani-report`;
