...
const ShouchalayList = () => {
  ...
  useEffect(() => {
    document.title = 'Shouchalay List - शौचालय यादी';
    (async () => {
  ...
  const handleViewReport = (ward: string | number) => {
    sessionStorage.setItem('shouchalayReportWard', String(ward));
    const newWindow = window.open('/view-shouchalay-report', '_blank');
    if (newWindow) {
