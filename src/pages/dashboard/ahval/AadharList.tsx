...
const AadharList = () => {
  ...
  const [wardsData] = useState<WardData[]>([
    { wardNo: 1, wardName: 'प्रभाग १', totalProperties: 150, totalPopulation: 780, aadharLinked: 650 },
    { wardNo: 2, wardName: 'प्रभाग २', totalProperties: 200, totalPopulation: 1050, aadharLinked: 890 },
    { wardNo: 3, wardName: 'प्रभाग ३', totalProperties: 180, totalPopulation: 920, aadharLinked: 750 },
    { wardNo: 4, wardName: 'प्रभाग ४', totalProperties: 165, totalPopulation: 850, aadharLinked: 720 },
    { wardNo: 5, wardName: 'प्रभाग ५', totalProperties: 190, totalPopulation: 980, aadharLinked: 810 },
    { wardNo: 6, wardName: 'प्रभाग ६', totalProperties: 175, totalPopulation: 890, aadharLinked: 780 },
    { wardNo: 7, wardName: 'प्रभाग ७', totalProperties: 195, totalPopulation: 1020, aadharLinked: 850 },
    { wardNo: 8, wardName: 'प्रभाग ८', totalProperties: 185, totalPopulation: 950, aadharLinked: 800 },
  ]);
  ...
  const handleViewReport = async (ward: WardData) => {
    ...
    sessionStorage.setItem('aadharReportWard', JSON.stringify(ward));

    // Open report in new tab
    const url = `/view-aadhar-report`;
