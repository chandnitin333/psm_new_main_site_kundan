    ...
    <div className="anuk-report bg-white text-black p-4" style={{ colorScheme: 'light' }}>
      <style>{`
        ...
        @media print {
          ...
          .anuk-report th, .anuk-report td { font-size: 14px !important; line-height: 1.35 !important; padding: 5px 8px !important; }
          .anuk-report thead { display: table-header-group; }
        }`}</style>
        ...
        {!isPublicReportMode() && (
          <button
            onClick={() => {
              ...
              window.open('/view-anukramika-card?variant=namuna8anu', '_blank');
            }}
