...
/* ना हरकत प्रमाणपत्र (No Objection Certificate) — certifies the GP has no objection. */
const NOCCertificate = () => {
  ...
  const canAdd = can(certModuleKey('noc'), 'add');
  const canPrint = can(certModuleKey('noc'), 'print');
  useEffect(() => {
    ...
    <div className="p-4 sm:p-6 print:p-0">
      ...
      <div className={isView ? '' : 'grid grid-cols-1 gap-6 lg:grid-cols-2'}>
        ...
        <div className="no-print rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <h2 className="mb-4 text-lg font-bold text-gray-900 dark:text-white">ना हरकत प्रमाणपत्र — तपशील भरा</h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <label className={label}>कशासाठी ना हरकत</label>
              <MarathiInput name="nocFor" value={f.nocFor} onChange={on} className={inp} placeholder="उदा. वीज जोडणी / व्यवसाय" />
            </div>
            <div className="sm:col-span-2">
              <label className={label}>अधिक तपशील (ऐच्छिक)</label>
              <MarathiInput name="details" value={f.details} onChange={on} className={inp} placeholder="अधिक तपशील" />
            </div>
            <div className="sm:col-span-2">
              <label className={label}>कारण / प्रयोजन</label>
              <MarathiInput name="purpose" value={f.purpose} onChange={on} className={inp} placeholder="उदा. अर्ज सादर करणे" />
            </div>
            <div>
        ...
        <div className={isView ? '' : 'lg:sticky lg:top-4 lg:self-start'}>
          ...
          >
            <p className="text-justify">
              ...
              <strong>{f.address || '____________'}</strong>, हे/ही या ग्रामपंचायत हद्दीतील रहिवासी
              आहेत. त्यांना <strong>{f.nocFor || '________________'}</strong> यासाठी या ग्रामपंचायतीची
              कोणतीही हरकत नाही.
            </p>
            {f.details ? (
              <p className="mt-3 text-justify">{f.details}</p>
            ) : null}
            <div className="mt-4">
