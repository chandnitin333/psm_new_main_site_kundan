...
const CharacterCertificate = () => {
  ...
  const [f, setF] = useState({
    ...
    address: '', conduct: 'चांगले', criminalRecord: 'नाही', purpose: '',
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await certificateService.save({
        cert_type: 'character',
        cert_name: 'चारित्र्य प्रमाणपत्र',
    ...
    <div className="p-4 sm:p-6 print:p-0">
      ...
      <div className={isView ? '' : 'grid grid-cols-1 gap-6 lg:grid-cols-2'}>
        ...
        <div className="no-print rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <h2 className="mb-4 text-lg font-bold text-gray-900 dark:text-white">चारित्र्य प्रमाणपत्र — तपशील भरा</h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              <label className={label}>वर्तन व चारित्र्य</label>
              <select name="conduct" value={f.conduct} onChange={on} className={inp}>
            ...
            <div>
              <label className={label}>गुन्हेगारी नोंद</label>
              <select name="criminalRecord" value={f.criminalRecord} onChange={on} className={inp}>
            ...
            <div className="sm:col-span-2">
              ...
              <MarathiInput name="purpose" value={f.purpose} onChange={on} className={inp} placeholder="उदा. नोकरी / शैक्षणिक" />
            </div>
            <div>
        ...
        <div className={isView ? '' : 'lg:sticky lg:top-4 lg:self-start'}>
          ...
          >
            <p className="text-justify">
              ...
              हे/ही या ग्रामपंचायत हद्दीतील रहिवासी असून, माझ्या माहितीप्रमाणे त्यांचे वर्तन व चारित्र्य{' '}
              <strong>{f.conduct || '________'}</strong> आहे. त्यांच्याविरुद्ध कोणतीही गुन्हेगारी/फौजदारी नोंद{' '}
              <strong>{f.criminalRecord || '________'}</strong>.
            </p>
            <div className="mt-4">
