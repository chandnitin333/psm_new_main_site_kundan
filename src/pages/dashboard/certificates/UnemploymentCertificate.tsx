...
/* बेरोजगारी प्रमाणपत्र (Unemployment Certificate). */
const UnemploymentCertificate = () => {
  ...
  const canAdd = can(certModuleKey('unemployment'), 'add');
  const canPrint = can(certModuleKey('unemployment'), 'print');
  useEffect(() => {
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await certificateService.save({
        cert_type: 'unemployment',
        cert_name: 'बेरोजगारी प्रमाणपत्र',
    ...
    <div className="p-4 sm:p-6 print:p-0">
      ...
      <div className={isView ? '' : 'grid grid-cols-1 gap-6 lg:grid-cols-2'}>
        ...
        <div className="no-print rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <h2 className="mb-4 text-lg font-bold text-gray-900 dark:text-white">बेरोजगारी प्रमाणपत्र — तपशील भरा</h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <label className={label}>शैक्षणिक पात्रता</label>
              <MarathiInput name="education" value={f.education} onChange={on} className={inp} placeholder="उदा. बी.ए., बी.कॉम." />
            </div>
            <div className="sm:col-span-2">
              <label className={label}>कारण / प्रयोजन</label>
              <MarathiInput name="purpose" value={f.purpose} onChange={on} className={inp} placeholder="उदा. नोकरीसाठी अर्ज" />
            </div>
            <div>
        ...
        <div className={isView ? '' : 'lg:sticky lg:top-4 lg:self-start'}>
          <CertificateLayout
            title="बेरोजगारी प्रमाणपत्र"
            subtitle="(Unemployment Certificate)"
          ...
          >
            <p className="text-justify">
              ...
              <strong>{f.age || '____'}</strong> वर्षे, रा.{' '}
              <strong>{f.address || '____________'}</strong>, शैक्षणिक पात्रता{' '}
              <strong>{f.education || '________'}</strong>, हे/ही या ग्रामपंचायत हद्दीतील रहिवासी
              असून सध्या बेरोजगार आहेत. ते/त्या कोणत्याही शासकीय/निमशासकीय/खाजगी सेवेत कार्यरत नाहीत.
            </p>
            <div className="mt-4">
              <Row k="शैक्षणिक पात्रता" v={f.education || '__________'} />
